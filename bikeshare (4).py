...
def get_filters():
    ...
    month =input("which Month (all,january,feruary,...,june)?")
    ...
    while day.lower() != 'all' and day.lower() != 'monday' and day.lower() !='tuesday' and day.lower() !='sunday':
        day=input("which day (all, monday, tuesday,... sunday) ?")    
        day= day.lower() 
...
def load_data(city, month, day):
    ...
    #extract month, day of week,hour form Start Time to create new columns
...
def user_stats(df):
    ...
    # TO DO: Display earliest, most recent, and most common year of birth
     ...
     print('There is no Gender and Birth Year in washington data')
...
def rawData(df):
    count= 0
    while True:
        rawData=input("would you like to see the rawData?yes or no:")     
